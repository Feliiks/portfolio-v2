  ...
  return (
    <div className="row section-works">
      ...
      <div className="row work-container mx-auto mt-5 mb-5 p-0 d-flex justify-content-between">
        <div className="work-content col-6 p-0 d-flex flex-column justify-content-between">
        ...
        <div className="work-carousel col-6 p-0 d-flex align-items-center justify-content-end">
