        ...
        <div className="section-bg container">
          <div className="row section-works">
            ...
            <div className="row mt-5">
              ...
              <p>
                ...
                ***** est un camping proposant des locations de mobil homes.
                ...
                a souhaité mettre en place une application mobile sur laquelle les salariés
                peuvent gérer les locations, les réservations ainsi que les utilisateurs.
                <br/>
            ...
            <div className="row mt-5">
              ...
              <p>
                Ce projet a demandé environ 30 jours de développement, seul. Il m'a
                permis de monter en compétences sur une toute nouvelle technologie (Flutter)
                mais aussi de découvrir le développent mobile.
                <br/><br/>
                Ayant déjà développé l'API, la masse de travail était moindre que pour
                l'application web mais étant novice dans ce type de développement, ce
                projet m'a demandé un grand travail de recherche et de persévérance.
                <br/><br/>
                La mise en place du système d'authentification et de navigation a été
                pour moi la partie la plus difficile. J'ai dû faire face à plusieurs problèmes
                qui m'ont ralenti pendant le développement mais avec de la résilience, ce projet
